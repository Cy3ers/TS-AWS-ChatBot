...
const Options = ({ state, updateState }: { state: ChatStateType; updateState: Dispatch<ChatStateType> }) => (
  <Flex
    width='700px'
    height={"300px"}
...
export const Start = ({ state, updateState }: { state: ChatStateType; updateState: Dispatch<ChatStateType> }) => {
  return (
    <Flex
      flexDir={"column"}
      justifyContent={"space-around"}
